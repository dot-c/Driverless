				...
				<div class="row">
					<div class="col-md-4">
						...
						<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
							<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="faq-name" placeholder="Name">
						</div>
					</div>
					...
					<div class="col-md-4">
						...
						<div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
							<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="faq-email" placeholder="Email">
						</div>
					</div>
					...
					<div class="col-md-4">
						...
						<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
							<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="faq-phone" placeholder="Phone">
						</div>
					</div>
					...
					<div class="col-12">
						...
						<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
							<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="faq-subject" placeholder="Subject">
						</div>
						<!-- Message -->
						<span class="txt9">
							Message
						</span>
						<textarea class="bo-rad-10 size35 bo2 txt10 p-l-20 p-t-15 m-b-10 m-t-3" name="faq-message" placeholder="Type your question here"></textarea>
					</div>
				</div>
